...
#Spike in 2014 (Operation Protective Edge launched by Israel), 2008-2009 (Gaza War), and 2000-2005(second intifada)
...
#however, The slope is 14.9. This implies that for every 1 year increase in time, the predicted best estimate of deaths willincreases by 14.9 deaths.
...
#plot is moderately strong, positive-ish. also spikes in intifada & 2014, but not in 08 or 09
...
#plot is weak. spikes in second intifada, but also 2006-2008. only a slight spike in 2014.
